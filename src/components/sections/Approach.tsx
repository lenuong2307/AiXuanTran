      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto mb-16">
          ...
          <motion.h2 
            ...
            className="text-xl sm:text-2xl md:text-3xl lg:text-[40px] font-heading font-bold mb-6 pt-2 leading-[1.4] md:leading-[1.2] tracking-tight md:tracking-normal sm:whitespace-nowrap"
          >
